  ...
  return (
    <div id="___gatsby">
      <div style={{ outline: "none" }} tabIndex={-1} id="gatsby-focus-wrapper">
        <div className="MuiGrid-root jss1 MuiGrid-container MuiGrid-direction-xs-column MuiGrid-align-items-xs-flex-end MuiGrid-justify-xs-center">
          <button
            className="MuiButtonBase-root MuiFab-root jss105"
            tabIndex={0}
            type="button"
            aria-label="theme changer"
          >
            <span className="MuiFab-label">
              <h5 className="MuiTypography-root MuiTypography-h5">🏙</h5>
            </span>
            <span className="MuiTouchRipple-root" />
          </button>
          <button
            className="MuiButtonBase-root MuiFab-root jss149"
            tabIndex={0}
            type="button"
        ...
        <a href="/" style={{ textDecoration: "none" }}>
          <button
            className="MuiButtonBase-root MuiFab-root jss359"
            tabIndex={0}
            type="button"
          >
            <span className="MuiFab-label">
        ...
        <div className="MuiContainer-root jss358 MuiContainer-maxWidthXl">
          <div className="jss357">
            ...
            >
              ...
              <img
                aria-hidden="true"
                src="data:image/jpeg;base64,"
                alt=""
                style={{
                  position: "absolute",
                  top: "0px",
              ...
              <picture>
                <source
                  srcSet="/static/c33dcc0d6e3e6e15d78fc07d471a161c/74cef/missing_puzzle.jpg 270w,
/static/c33dcc0d6e3e6e15d78fc07d471a161c/9f5e4/missing_puzzle.jpg 540w,
/static/c33dcc0d6e3e6e15d78fc07d471a161c/dca3b/missing_puzzle.jpg 1080w,
/static/c33dcc0d6e3e6e15d78fc07d471a161c/e6125/missing_puzzle.jpg 1440w"
...
/static/c33dcc0d6e3e6e15d78fc07d471a161c/dca3b/missing_puzzle.jpg 1080w,
/static/c33dcc0d6e3e6e15d78fc07d471a161c/e6125/missing_puzzle.jpg 1440w"
                  src="/static/c33dcc0d6e3e6e15d78fc07d471a161c/dca3b/missing_puzzle.jpg"
                  alt=""
                  loading="lazy"
                  style={{
                    position: "absolute",
              ...
              <noscript>
                &lt;picture&gt;&lt;source
                srcset="/static/c33dcc0d6e3e6e15d78fc07d471a161c/74cef/missing_puzzle.jpg
                270w,
                /static/c33dcc0d6e3e6e15d78fc07d471a161c/9f5e4/missing_puzzle.jpg
                540w,
                /static/c33dcc0d6e3e6e15d78fc07d471a161c/dca3b/missing_puzzle.jpg
                1080w,
                /static/c33dcc0d6e3e6e15d78fc07d471a161c/e6125/missing_puzzle.jpg
                1440w" sizes="(max-width: 1080px) 100vw, 1080px" /&gt;&lt;img
        ...
        <div className="MuiContainer-root MuiContainer-maxWidthLg">
          <div className="MuiPaper-root jss356 MuiPaper-elevation1 MuiPaper-rounded">
            <div className="MuiContainer-root MuiContainer-maxWidthXl">
              <div>
                <p>
                  Hi everyone, long time no see 👋. Today, I am very excited to
                  talk to you guys about <strong>AutoMapper</strong> (
                  <code className="language-text">@nartc/automapper</code>)
                  version 6. This is a release with an <em>almost complete</em>{" "}
                  rewritten core and some small changes to the public API, for
                  the better.
                </p>
                <blockquote>
                  <p>
                    If you do not know about <strong>AutoMapper</strong>, you
                    can find out more about it via this blog post{" "}
                ...
                <p>
                  I have updated the benchmark code and have ran all benchmarks
                  100 times instead of 10 times. You can check out the benchmark
                  repo{" "}
                  <a
                ...
                <p>
                  This v6 release does not contain many changes regarding the
                  public API but performance, bundle-size, critical bug fixes,
                  and a stab at <strong>JavaScript</strong> support were the
                  main targets of this release. Let’s explore 💪
                </p>
                ...
                <p>
                  ...
                  <strong>AutoMapper</strong>, performance is not to take
                  lightly. However before we dive into the performance of{" "}
                  ...
                  <strong>View Model (client/frontend)</strong> via API calls.
                  This is to point out that the number of items going back and
                  forth Network Calls should not be too many like hundreds of
                  thousands or millions of objects going through a single
                  network call. With that in mind,
                  <strong>mapping</strong> such big amount of objects at once is
                  not realistic in my opinion. Although, I would love for{" "}
                  <strong>AutoMapper</strong> to have better performance than
                  not. Let’s take a look at some simple statistics, shall we?
                </p>
                <p>
                ...
                <div className="gatsby-highlight" data-language="typescript">
                  ...
                  >
                    <code className="language-typescript">
                      ...
                      Date<span className="token punctuation">;</span>
                      {"\n"}
                      <span className="token punctuation">{"}"}</span>
                      {"\n"}
                      {"\n"}
...
Mapper.createMap(Bio, BioVm)
  ...
  .forMember(
    ...
    mapFrom((s) => s.birthday.toDateString())
                ...
                <blockquote>
                  <p>
                    Each benchmark was ran ~10~ 100 times for each category 1K,
                    10K, and 100K then the average was taken
                  </p>
                </blockquote>
                <p>
                  As you can see, <strong>AutoMapper</strong> v6 is slightly
                  faster than v5, about 10-25% faster. And what really changed
                  in v6? <strong>AutoMapper</strong> v6 does have some
                  optimizations applied to it, as follow:
                </p>
                <ul>
                  <li>
                    ...
                    <strong>initializing mapping properties</strong>. In areas
                    where <code className="language-text">for let</code> is
                    still used, v6 has the property{" "}
                    <code className="language-text">length</code> cached to
                    avoid additional{" "}
                    <code className="language-text">property lookup</code> for
                    every iterations.
                  </li>
                  <li>
                    Accessing Array Index: v6 moves a large part of the core’s
                    data structures from{" "}
                    <code className="language-text">Object</code> to{" "}
                    <code className="language-text">Array</code> to also avoid{" "}
                    <code className="language-text">property lookup</code>.
                    About this technique, there are still areas in the code base
                    where this can be applied further.
                  </li>
                </ul>
                <blockquote>
                  <p>
                    You can learn more about{" "}
                    <strong>Accessing Array Index</strong> from the talk{" "}
                    <a
                ...
                <p>
                  ...
                  <code className="language-text">morphism</code> benchmark with
                  the same mapping configuration as above:
                </p>
                <div
                  className="gatsby-code-button-container"
  ...
  bio: {
    ...
    birthday: ({ bio }) => bio.birthday.toDateString(),
                ...
                <div className="gatsby-highlight" data-language="typescript">
                  ...
                  >
                    <code className="language-typescript">
                      ...
                      morphismSchema <span className="token operator">=</span>{" "}
                      <span className="token punctuation">{"{"}</span>
                      {"\n"}
                      {"  "}first<span className="token operator">:</span>{" "}
                      ...
                      <span className="token parameter">
                        <span className="token punctuation">{"{"}</span>{" "}
                        firstName<span className="token punctuation">,</span>{" "}
                        lastName{" "}
                        <span className="token punctuation">{"}"}</span>
                      </span>
                      <span className="token punctuation">)</span>{" "}
                ...
                <p>
                  ...
                  <strong>mapping</strong> part of the two libraries. Utility
                  wise, <code className="language-text">morphism</code> is a
                  fantastic library that supports mapping with{" "}
                  <strong>schema configuration</strong> and this suits perfectly
                  with <strong>Vanilla JavaScript</strong> projects, which do
                  not have <code className="language-text">classes</code> to
                  model the data in the projects. You can also store the{" "}
                  <strong>schema configuration</strong> elsewhere (database,
                  CDN) and reuse the <strong>schema configuration</strong>{" "}
                  without having the schema inside of your source code. If you
                  find <code className="language-text">morphism</code>{" "}
                  interesting, please check it out at{" "}
                  <a
                    href="https://github.com/nobrainr/morphism"
                    target="_blank"
                    rel="nofollow noreferrer"
                ...
                <p>
                  Overall, the bundle-size of v6 is sightly smaller than v5. All
                  of the utility functions and some of the core parts were
                  cleaned up pretty heavily.
                  <span
...
/static/b479a1493e757b87949f625d23c11a31/293b3/next.png 433w"
                ...
                <p>
                  ...
                  <strong>mapping configuration</strong> with the difference
                  between v5 and v6:
                </p>
                <div
                  className="gatsby-code-button-container"
  ...
  .forMember(
    ...
    mapFrom((s) => s.firstName + " " + s.lastName)
                ...
                <p>
                  ...
                  interface that contains all{" "}
                  <strong>mapping operations</strong> like:
                  ...
                  <code className="language-text">Pure Functions</code>. This
                  allows for <code className="language-text">tree-shaking</code>{" "}
                  tools to do their job.
                </p>
                <blockquote>
                  <p>
                    <code className="language-text">tree-shaking</code> is a
                    step during Build/Bundle. It means to eliminating dead-code
                    (unused code). Dead code, like{" "}
                    <code className="language-text">Functions</code> that are
                    declared but are not used, will be removed from the final
                    bundle which results in a much smaller bundle-size. Only pay
                    for what you use kind of thing.
                  </p>
                </blockquote>
                ...
                <p>
                  In the previous versions of <strong>AutoMapper</strong>, all
                  of the <strong>Mappings</strong> and <strong>Profiles</strong>{" "}
                  were stored in a form of{" "}
                  <code className="language-text">Object</code> (or{" "}
                  <code className="language-text">Dictionary</code>) with their{" "}
                  ...
                  class name are also “uglified” which ultimately leads to
                  duplicate <code className="language-text">
                    keys
                  </code> forcing <strong>AutoMapper</strong> to throw
                ...
                <p>
                  ...
                  classes themselves as{" "}
                  <code className="language-text">key</code> instead of using{" "}
...
console.log(Foo.prototype.constructor.name); // logs Foo`, `55133853605173330000`)"
                ...
                <p>
                  Before v6, support for <strong>JavaScript</strong> is
                  essentially non-existent. <strong>AutoMapper</strong> has been
                  working only with <strong>TypeScript</strong> projects. From
                  v6, this will change as <strong>AutoMapper</strong> will
                  provide a new API to work with <strong>JavaScript</strong>.
                  Before introducing this API, I would like to skim through how{" "}
                  <strong>AutoMapper</strong> works so you guys can understand
                  how it has only been supporting <strong>TypeScript</strong>
                </p>
                <p>
                  ...
                  <code className="language-text">lastName</code> is a string,
                  and <code className="language-text">bio</code> is a{" "}
                  <code className="language-text">Bio</code>. These are
                  so-called <strong>Metadata</strong>. To get a hold of these
                  information at runtime, <strong>AutoMapper</strong> uses a
                  decorator <code className="language-text">@AutoMap()</code>.
                  Afterwards,{" "}
                  <code className="language-text">MetadataStorage</code> will
                  step in and store these metadata, that{" "}
                  <code className="language-text">@AutoMap()</code> provides,
                  for each unique Model. In <strong>Vanilla JavaScript</strong>{" "}
                  projects, it is quite complicated to setup your project to use{" "}
                  <code className="language-text">decorators</code>, and{" "}
                  <strong>AutoMapper</strong> itself did not have any API to
                  support <strong>JavaScript</strong>.
                </p>
                <p>
                  The API that v6 will provide is:{" "}
                  <code className="language-text">createMapMetadata()</code>.
                  This API will simulate how{" "}
                  <code className="language-text">@AutoMap()</code> works so
                  metadata can be stored. However, this early-versioned API will
                  still require the consumers to provide some amount of
                  boiler-plate code
                </p>
                <div
                  className="gatsby-code-button-container"
...
class BioVm {}`, `52497728617914480000`)"
                ...
                <p>
                  ...
                  <code className="language-text">fields</code> do not have to
                  be declared. But these empty classes are required to ensure
                  the uniqueness of the Models.
                </p>
                <div
                  className="gatsby-code-button-container"
...
createMapMetadata(UserVm, {
  ...
  bio: BioVm,
                ...
                <div className="gatsby-highlight" data-language="javascript">
                  ...
                  >
                    <code className="language-javascript">
                      ...
                      {"\n"}
                      {"  "}isAdult<span className="token operator">:</span>{" "}
                      Boolean<span className="token punctuation">,</span>
                      {"\n"}
                      {"  "}birthday<span className="token operator">:</span>{" "}
                      String<span className="token punctuation">,</span>
                      {"\n"}
                ...
                <p>
                  Too boiler-platey right? Well, consumers do not have to
                  provide information for each and every fields like above. Only
                  fields that <strong>ARE NOT</strong> configured manually by{" "}
                  <code className="language-text">.forMember()</code> are
                  required to be provided. So with the configuration in the
                  beginning of the blog,{" "}
                  <code className="language-text">isAdult</code> and{" "}
...
createMapMetadata(UserVm, {
  bio: BioVm,
                ...
                <p>
                  ...
                  <code className="language-text">BioVm -&gt; Bio</code>).
                  Fields that <strong>ARE</strong> configured manually by{" "}
                ...
                <p>
                  You can try out <strong>AutoMapper</strong> v6 by installing
                ...
                <ul>
                  <li>
                    ...
                    <strong>mapping operations</strong> are separate functions
                    in v6. So you configuration needs to be changed:
                  </li>
                </ul>
                <div
                  className="gatsby-code-button-container"
...
Mapper.createMap(User, UserVm)
    ...
    .forMember(d => d.foo, ignore())`, `84330171426046690000`)"
                ...
                <ul>
                  <li>
                    <code className="language-text">Mapper.initialize()</code>{" "}
                    has been deprecated. Please use{" "}
                    <code className="language-text">Mapper.createMap()</code>,{" "}
                    <code className="language-text">Mapper.addProfile()</code>,
                    and{" "}
                    <code className="language-text">
...
Mapper.createMap(User, UserVm, {
  sourceMemberNamingConvention: PascalCaseNamingConvention,
                ...
                <p>
                  ...
                  <strong>AutoMapper</strong> a try should the library fits
                  their use-cases. Thank you for reading and I will see you in
                  the next one. 👋
                </p>
              </div>
            </div>
      ...
      <div
        ...
        aria-atomic="true"
      >
        Navigated to What's new in AutoMapper v6? | tnc
      </div>
    </div>
  );
}
